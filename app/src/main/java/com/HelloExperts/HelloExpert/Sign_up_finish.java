...
public class Sign_up_finish extends AppCompatActivity {
    TextView contact_us,expected_date;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        expected_date = (TextView)findViewById(R.id.expected_date);
        ...
        expected_date.setText(getIntent().getExtras().getString("expected_date"));
